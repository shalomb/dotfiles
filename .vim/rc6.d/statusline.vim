...
highlight User1  ctermbg=234 ctermfg=8  cterm=None
highlight User2  ctermbg=234 ctermfg=9  cterm=bold
highlight User3  ctermbg=234 ctermfg=40 cterm=bold
highlight User4  ctermbg=234 ctermfg=39
highlight User5  ctermbg=234 ctermfg=14
highlight User6  ctermbg=234 ctermfg=29
highlight User7  ctermbg=234 ctermfg=60
highlight User8  ctermbg=234 ctermfg=75
highlight User9  ctermbg=234 ctermfg=8
