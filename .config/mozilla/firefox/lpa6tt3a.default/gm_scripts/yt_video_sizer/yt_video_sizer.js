...
window.setTimeout(
  function () {
    ...
    try {
      var player2              = $("movie_player");

      player2.style.marginLeft = (  window.innerWidth >= 960 
                                    ? (985 - window.innerWidth) / 2 
                                    : "0"
                                ) + "px";
      player2.style.width      = (window.innerWidth  - 30) + "px";
      player2.style.height     = (window.innerHeight - 50) + "px";
    } catch (e) {}
